...
var file_team_v1_team_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x74, 0x65, 0x61, 0x6d, 0x2e, 0x76, 0x31, 0x22, 0x4c, 0x0a,
	...
	0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x65, 0x0a, 0x05, 0x47,
...
func file_team_v1_team_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_team_v1_team_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Team); i {
			case 0:
				return &v.state
			case 1:
		...
		file_team_v1_team_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Group); i {
			case 0:
				return &v.state
			case 1:
